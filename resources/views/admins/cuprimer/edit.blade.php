...
<section class="content-header">
    <h1>
        ...
        <small>Mengubah CU Primer</small>
    </h1>
    <ol class="breadcrumb">
...
{{ Form::model($data,array('route' => array('admins.'.$kelas.'.update',$data->id),'files' => true,'method' => 'put','data-toggle' => 'validator','role' => 'form')) }}
